---
name: xxd-panel-219
description: "Create Panel 219 raster artwork: Doodle Travel Sketch with Pencil Accents. Use when the user invokes xxd-panel-219 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-219/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-219-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
